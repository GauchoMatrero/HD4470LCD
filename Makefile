...
# adapted and used for the ATTiny2313 I2C Keypad and LCD controller by John Crouchley.
...
# do not need a port for usbisp
#AVRDUDE_PORT = com7			# for avrisp
...
SRC = $(TARGET).c usiTwiSlave.c wiring.c LCD4Bit.c Keyboard.c
...
AVRDUDE_FLAGS = -p $(MCU) -c $(AVRDUDE_PROGRAMMER) -u
...
AVRDUDE_WRITE_FUSE = -U lfuse:w:0xE4:m #run with 8 Mhz clock
...
DIRAVR = C:\Arduino\WinAVR-20090313
